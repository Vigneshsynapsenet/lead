...
curl -sLo docker-compose.yml https://raw.githubusercontent.com/Viggicmr/lead/feature/template_campaign/packages/twenty-docker/dev/docker-compose.yml

# Copy twenty/packages/twenty-docker/.env.example to .env
echo -e "\t• Setting up .env file"
curl -sLo .env https://raw.githubusercontent.com/Viggicmr/lead/feature/template_campaign/packages/twenty-docker/.env.example
